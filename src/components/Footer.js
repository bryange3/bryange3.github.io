    ...
    return (
        <footer className="sticky-footer">
            ...
            <ul>
                ...
                <li><a href="https://drive.google.com/file/d/1e-ACTyMqLo_neKqfUbgBYhQwGw_DjD7e/view?usp=sharing" target="_blank" rel="noreferrer" className="social" alt="Resume">Resume</a></li>
                <li><a href="https://www.linkedin.com/in/bryange/" target="_blank" rel="noreferrer" className="social" alt="LinkedIn">LinkedIn</a></li>
