    ...
    return (
        <FadeIn className="text-pretty">
            <div className="mx-6 md:mx-auto max-w-2xl">
                ...
                <p className="text-lg text-gray-500">Overview</p>
                ...
                <p className="text-lg text-gray-900 bg-gray-200 p-4 rounded-md">We shipped the dashboard in February 2022 to 250+ admin and contributors at South Side Weekly! After usage, the managing director even stated he believed our dashboard could be scaled for use at other newspaper nonprofits. 😎</p>


                <p className="text-lg text-gray-500 mt-16">Context</p>
            ...
            <div className="mx-6 md:mx-auto max-w-2xl mt-12">
                <p className="text-lg text-gray-500 mt-16">Goals</p>
                ...
                <p className="text-lg text-gray-500 mt-16">Main Features</p>
                <p className="text-3xl font-semibold text-gray-900 font-serif mt-8">Contributors</p>
            ...
            <div className="mx-6 md:mx-auto max-w-2xl mt-12">
                <p className="text-lg text-gray-500 mt-16">Research</p>
            ...
            <div className="mx-6 md:mx-auto max-w-2xl mt-12">
                <p className="text-lg text-gray-500 mt-16">Insights</p>
                ...
                <p className="text-lg text-gray-500 mt-16">Exploration</p>
            ...
            <div className="mx-6 md:mx-auto max-w-2xl">
                ...
                <ul className="text-lg text-gray-900 list-disc list-outside ml-3 space-y-1.5 mb-4">
                    <li>
            ...
            <div className="mx-6 md:mx-auto max-w-2xl">
                ...
                <p className="text-lg text-gray-900 font-semibold mt-10">
            ...
            <div className="mx-6 md:mx-auto max-w-2xl">
                <p className="text-lg text-gray-900 bg-gray-200 p-4 rounded-md"><a href="mailto:bryange3@gmail.com" target="_blank" rel="noopener noreferrer" alt="Email">Email me</a> for a deeper dive and my reflection on how I would improve the visual design, UX writing, and information architecture.</p>

                <div className="grid grid-cols-2 text-lg mt-16">
