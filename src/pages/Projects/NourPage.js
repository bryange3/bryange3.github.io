...
import redesign from '../../assets/project/nour/NourRedesign.png';
                ...
                <body>
                    <div className="med-text">
                        ...
                        <p className="paragraph">
                            ...
                            <h3 className="subsection">
                                I would utilize native UI patterns because of familiarity and take privacy into account, especially because many people of older age groups tend to be more careful about data access.
                            </h3>
                        </p>
                    </div>
                    ...
                    <div className="med-text">
                        ...
                        <p className="paragraph">
                            Check out our <a href="https://www.figma.com/file/o2siBMfCFww1ksk5Xz7ZE5/HackDuke-Ideate-2021-Nour?node-id=0%3A1" target="_blank" rel="noopener noreferrer" className="link-underline">Figma document</a> and play around with the prototype below!
                        </p>
