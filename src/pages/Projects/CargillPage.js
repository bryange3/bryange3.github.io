...
import fridge from '../../assets/project/cargill/fridge.png';
import teamscall from '../../assets/project/cargill/teamscall.png';
            ...
            <Content width={width}>
                <body>
                    ...
                    <p className="paragraph">
                        ...
                        <Row>
                            <Col>
                                <img src={fridge} alt="Cargill Devs" className="project-img center" />
                            </Col>
                            <Col>
                                <img src={teamscall} alt="Cargill Devs" className="project-img center" />
                            </Col>
                        </Row>
                        ...
                        <p className="paragraph">
                            <ul>
                                ...
                                <li><a className="link-underline" target="_blank" rel="noreferrer" href="https://www.renzomledesma.me/">Renzo Ledesma</a></li>
                                <li><a className="link-underline" target="_blank" rel="noreferrer" href="https://www.linkedin.com/in/mukundmadhusudan/">Mukund Madhusudan</a></li>
                            </ul>
                        </p>
                    </p>
                </body>
