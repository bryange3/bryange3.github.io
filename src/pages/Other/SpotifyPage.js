            ...
            <Content width={width}>
                <body>
                    <p className="impact-statement">
                        <span role="img" aria-label="Backhand Index Pointing Right">👉</span> Update: I've accepted an offer from Apple to be a Product Design Intern for this upcoming summer. However, if Spotify offers off-season product design internships I would love to apply and be considered. Thank you!
                    </p>

                    <p className="paragraph">
                        <p className="spotify-section my-blue">
                            <span role="img" aria-label="Smiling Face with Halo">😇</span> As a brief introduction...
                        </p>
                    ...
                    <p className="paragraph">
                        <p className="spotify-section my-blue">
                            <span role="img" aria-label="Paperclip">📎</span> Moving on to my experiences and skills!
                        </p>
                    ...
                    <p className="paragraph">
                        <p className="spotify-section my-blue">
                            <span role="img" aria-label="Trumpet">🎺</span> Why Spotify?
                        </p>
                        ...
                        <p className="spotify-subsection">
                            <span role="img" aria-label="Hundred Points Symbol">💯</span> How I reflect Spotify's core values...
                        </p>
