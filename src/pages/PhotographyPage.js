            ...
            <Content width={"100%"}>
                <Container fluid={true}>
                    <Row className="justify-content-center">
                        <Col sm={3}>
                            <img src={aboveclouds} className="photo" alt="little house on the mountain above the clouds at Point Reyes in California" />
                            <img src={bench} className="photo" alt="my three friends sitting on a bench during fall when the leaves are changing a yellow color" />
                            <img src={coffee} className="photo" alt="my friend leaning her arms against a table in a coffee shop" />
                            <img src={fork} className="photo" alt="perspective of a fork stabbed into a lemon bar" />
                            <img src={cvad} className="photo" alt="cvad" />
                        </Col>
                        <Col sm={3}>
                            <img src={dragonfly} className="photo" alt="dragonfly" />
                            <img src={bored} className="photo" alt="Connie bored in a bookstore" />
                            <img src={canada} className="photo" alt="reflection of mountains at Lake Louise in Alberta, Canada" />
                            <img src={lookhere} className="photo" alt="2 pumpkins in the foreground framing my 2 friends" />
                            <img src={city} className="photo" alt="hectic New York City at night" />
                            <img src={night} className="photo" alt="friend in the dark, illuminated by red light" />
                            <img src={sunset} className="photo" alt="sunset at the pier" />
                        </Col>
                        <Col sm={3}>
                            <img src={blb} className="photo" alt="blb portrait" />
                            <img src={haze} className="photo" alt="haze at point reyes" />
                            <img src={peek} className="photo" alt="peek" />
                            <img src={mori} className="photo" alt="sunset at Mori Point in California" />
                            <img src={dessert} className="photo" alt="dessert" />
                        </Col>
                        <Col sm={3}>
                            <img src={lake} className="photo" alt="lake" />
                            <img src={joy} className="photo" alt="joy" />
                            <img src={fireysunset} className="photo" alt="firey red and orange sunset" />
