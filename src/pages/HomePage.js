        ...
        <FadeIn className="mx-6 md:mx-auto max-w-2xl">
            <div className="mt-24 md:mt-36 mb-16 text-pretty">
                ...
                <p className="text-xl text-gray-900">
                    Software designer at <a href="https://amplify.com/" target="_blank" rel="noopener noreferrer" alt="Amplify Education">Amplify Education</a>. Previously at <a href="https://apple.com" target="_blank" rel="noopener noreferrer" alt="Apple">Apple</a> and <a href="https://amazon.com" target="_blank" rel="noopener noreferrer" alt="Amazon">Amazon</a>.
                </p>
