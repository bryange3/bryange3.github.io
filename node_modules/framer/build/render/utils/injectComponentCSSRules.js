...
[data-framer-component-type="RichText"] p:not(:last-child),
[data-framer-component-type="RichText"] div:not(:last-child),
[data-framer-component-type="RichText"] h1:not(:last-child),
[data-framer-component-type="RichText"] h2:not(:last-child),
[data-framer-component-type="RichText"] h3:not(:last-child),
[data-framer-component-type="RichText"] h4:not(:last-child),
[data-framer-component-type="RichText"] h5:not(:last-child),
[data-framer-component-type="RichText"] h6:not(:last-child) {
...
const nativeStackGapRules = [
    `[data-framer-stack-content-wrapper][data-framer-stack-gap-enabled="true"] { gap: var(--stack-native-gap); }`,
    `.${flexboxGapNotSupportedClass} [data-framer-stack-content-wrapper][data-framer-stack-gap-enabled="true"] { gap: unset; }`,
];
const stackGapRule = `
