...
export const Text = React.forwardRef(function Text(props, forwardedRef) {
    ...
    const interceptPageLinks = React.useCallback((event) => {
        ...
        if (pageLink) {
            ...
            const elementId = anchorElement.getAttribute("data-framer-page-link-element" /* Element */) ?? undefined;
    ...
    const rawHTML = React.useMemo(() => {
        if (!props.rawHTML || onCanvas || !getRoute || !currentRouteId)
            return props.rawHTML;
        return replaceFramerPageLinks(props.rawHTML, getRoute, currentRouteId, pathVariables);
    }, [props.rawHTML, getRoute, onCanvas, currentRouteId, pathVariables]);
