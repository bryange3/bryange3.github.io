 ...
 */
function useFeatures(props, projectionId, visualElement, preloadedFeatures) {
    var features = [];
    ...
    for (var i = 0; i < numFeatures; i++) {
        ...
        if (isEnabled(props) && Component) {
            features.push(React__namespace.createElement(Component, tslib.__assign({ key: name_1 }, props, { visualElement: visualElement, projectionId: projectionId })));
        }
    }
    return features;
}
...
var VisualElementDragControls = /** @class */ (function () {
    ...
    VisualElementDragControls.prototype.snapToCursor = function (_point) { };
    /**
    ...
    VisualElementDragControls.prototype.scalePositionWithinConstraints = function () {
        var _this = this;
        var _a = this.getProps(), drag = _a.drag, dragConstraints = _a.dragConstraints;
        var projection = this.visualElement.projection;
...
function createMotionComponent(_a) {
    ...
    function MotionComponent(props, externalRef) {
        ...
        if (!config.isStatic && isBrowser) {
             ...
             */
            features = useFeatures(props, projectionId, // TODO Probably not needed here
            context.visualElement, preloadedFeatures);
            // TODO Allow lazy load of projection node
            var _a = React.useContext(SwitchLayoutGroupContext), transition = _a.transition, shouldPreserveFollowOpacity = _a.shouldPreserveFollowOpacity;
            useProjection(projectionId, props, context.visualElement, {
                transition: transition,
                shouldPreserveFollowOpacity: shouldPreserveFollowOpacity,
            });
        }
        /**
...
function renderHTML(element, _a, projection) {
    ...
    Object.assign(element.style, style, projection && projection.getProjectionStyles());
...
function createDomMotionConfig(Component, _a, preloadedFeatures, createVisualElement) {
    ...
    var baseConfig = isSVGComponent(Component)
        ? svgMotionConfig
        : htmlMotionConfig;
    return tslib.__assign(tslib.__assign({}, baseConfig), { preloadedFeatures: preloadedFeatures, useRender: createUseRender(forwardMotionProps), createVisualElement: createVisualElement, Component: Component });
}
...
function ReorderGroup(_a, externalRef) {
    var children = _a.children, _b = _a.as, as = _b === void 0 ? "ul" : _b, _c = _a.axis, axis = _c === void 0 ? "y" : _c, onReorder = _a.onReorder, props = tslib.__rest(_a, ["children", "as", "axis", "onReorder"]);
 ...
 * @public
 */
var domMax = tslib.__assign(tslib.__assign(tslib.__assign({}, domAnimation), drag), layoutFeatures);
