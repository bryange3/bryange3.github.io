...
export declare function ReorderGroup<V>({ children, as, axis, onReorder, ...props }: Props<V> & HTMLMotionProps<any> & React.PropsWithChildren<{}>, externalRef?: React.Ref<any>): JSX.Element;
